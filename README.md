...
| ------------- | --------------------------- | --------------- | ------------- |     
| type          | grid_search                 | <ul><li>grid_search</li><li>bayesian</li></ul> | Defines which type of hyperparameters optimization we run. Grid search is better for parallelization, while the bayesian optimization can find better sets of hyperparameters. |
